...
/**
 * print_class - Print the ELF header's class.
...
/**
 * print_data - Print the ELF header's data.
...
/**
 * print_version - Print the ELF header's version.
...
/**
 * print_osabi - Print the ELF header's OS/ABI.
 * @e_ident: Pointer to ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
...
/**
 * print_abi - Print the ELF header's ABI version.
...
/**
 * print_type - Print the ELF header's type.
 * @e_type: The ELF type.
 * @e_ident: Pointer to ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
...
/**
 * print_entry - Print the ELF header's entry point.
